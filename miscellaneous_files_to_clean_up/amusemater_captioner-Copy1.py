...
get_ipython().system('jupyter nbconvert --to script amusemater_captioner-Copy1.ipynb')
with open('amusemater_captioner.py', 'r') as f:
    lines = f.readlines()
with open('amusemater_captioner.py', 'w') as f:
    for line in lines:
